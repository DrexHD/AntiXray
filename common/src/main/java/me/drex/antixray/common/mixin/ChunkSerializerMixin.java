...
public abstract class ChunkSerializerMixin {
    ...
    private static PalettedContainer<BlockState> setPresetValuesArgument(
        ...
        Operation<PalettedContainer<BlockState>> original, ServerLevel serverLevel, @Local(ordinal = 3) int sectionIndex
    ) {
        final BlockState[] presetValues = Util.getBlockController(serverLevel).getPresetBlockStates(serverLevel, sectionIndex << 4);
    ...
    private static DataResult<PalettedContainer<BlockState>> setPresetValuesArgument(
        Codec<PalettedContainer<BlockState>> instance, DynamicOps dynamicOps, Object data,
        Operation<DataResult<PalettedContainer<BlockState>>> original, ServerLevel serverLevel,
